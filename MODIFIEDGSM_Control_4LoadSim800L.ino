...
if(GSM_Msg=="Sok1on") {load1=0; sendSMS(GSM_Nr,"Ok Socket 1 is On");}
if(GSM_Msg=="Sok1off"){load1=1; sendSMS(GSM_Nr,"Ok Socket1 is Off");}

if(GSM_Msg=="Sok2on") {load2=0; sendSMS(GSM_Nr,"Ok Socket 2 is On");}
if(GSM_Msg=="Sok2off"){load2=1; sendSMS(GSM_Nr,"Ok Socket 2 is Off");}

if(GSM_Msg=="Sok3on") {load3=0; sendSMS(GSM_Nr,"Ok Socket 3 is On");}
if(GSM_Msg=="Sok3off"){load3=1; sendSMS(GSM_Nr,"Ok Socket 3 is Off");}

if(GSM_Msg=="Sok4on") {load4=0; sendSMS(GSM_Nr,"Ok Socket 4 is On");}
if(GSM_Msg=="Sok4off"){load4=1; sendSMS(GSM_Nr,"Ok Socket 4 is Off");}

if(GSM_Msg=="Onallsok") {load1=0, load2=0, load3=0, load4=0; sendSMS(GSM_Nr,"Ok All Sockets are On");}
if(GSM_Msg=="Offallsok"){load1=1, load2=1, load3=1, load4=1; sendSMS(GSM_Nr,"Ok All Sockets are Off");}
